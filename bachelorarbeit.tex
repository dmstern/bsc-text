...
Während der Entwickler ohne diesen Build-Service die verschiedenen Toolkits aller Zielplattformen lokal verwalten müsste, um Cordova zu verwenden,\footnote{\url{http://docs.phonegap.com/en/3.4.0/guide_cli_index.md.html\#The Command-Line Interface} % In Literatur-Verzeichnis (BibTeX) einfügen.
