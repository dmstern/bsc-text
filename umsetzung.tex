...
%TODO "Konzeption" und "Umsetzung" evtl. etwas ungünstige Überschriften, weil Teil schon Umsetzung heißt und die Aufteilung einfach nicht besonders sinnvoll ist?
\chapter{Konzeption}	
...
%TODO Evtl. "Anforderungen" mit "Funktionalitätsbeschreibung" verbacken. 
	%TODO --> Ist das nicht eh mehr oder weniger das gleiche?
	%TODO --> "Motivation, Idee" und "Funktionaltitätsbeschreibung" ist in dem Fall doch auch ähnlich.
	%TODO ANDERERSEITS: Gibts dann nur noch eine Section "Anforderungen".
		%TODO Entweder auch noch weg.
		%TODO Oder: Zweiteilung wieder einbauen, wenn sinnvoll.
...
\section{Ausgewählte Technologie und Architektur}	%TODO ist das aber nicht auch irgendwie Konzeption? --> Kapitelüberschriften leicht seltsam.
%TODO Zusammenhang zw. Knockout / MVVM bzw. Obsever-Pattern und Cordova erklären.
...
Ebenso ist aus dem selben Grund hier keine Einschränkung der durchsuchten Felder nötig, sodass durch der \lstinline|fields|-Parameter den Wert \lstinline|"*"| hat, und so alle Felder des \emph{Contact}-Objekts durchsucht werden (\linename 25). 
