\chapter{Praktische Umsetzung} \label{chap:praxis} % (mein Anteil)  verweis auf technische grundlagen.

	\section{Beispiel-Anwendung}\label{sec:bsp-app} %	Zu Explorationszwecken zu implementierender Anwendungsfall (App-Prototyp)
