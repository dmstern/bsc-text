...
Ein Nachteil der Implementierung als Hybrid-App gegenüber der nativen Entwicklung ist sicherlich das in \fullref{sec:contacts-ergebnis} erwähnte Fehlen von entsprechenden \gls{gui}-Komponenten für einen konkreten Anwendungsfall (bswp. \emph{Kontakte auswählen}). 
...
\image{performance}
	...
	{Vergleich Ausführungsgeschwindigkeit.}	%TODO Beschriftung hinzufügen!!!
...
%TODO Aber auch hier gibt es wieder Einschränkungen, was bspw. die Unterstützung bestimmter oder vieler verschiedener Plattformen. 
...
% Wie leicht lassen sich Hybrid-Apps hacken (also bspw. den bestehenden Code, so verändern, dass Schadcode in externe Systeme oder auch Clientgeräte eingeschleust werden kann)?
