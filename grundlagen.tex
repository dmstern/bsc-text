...
Auch bei \gls{websql} zeichnet sich ein ähnlich diffuses Bild ab \todo{stil!}: Während \gls{chrome} die Technologie ab der Version 4 und \gls{ios} ab Version 3.2 unterstützt, ist für Nutzer der Browser \gls{firefox} und \gls{ie} die Technik gar nicht verfügbar.
...
%TODO Fussnote auf der übernächsten Seite????
...
%TODO Positionierung der Grafik!
\begin{figure}
\centering
