...
Die Grundlage des langjährigen Standards für die Enwicklung von Internetseiten bietet HTML (Hyper Text Markup Language), mit der Webseiten und deren Aussehen textuell beschrieben werden kann. In Kombination mit CSS (Cascading Style Sheets) für das modulare Styling einer Website sowie Javascript, einer Skriptsprache zur Manipulation von DOM-Dokumenten\todo{dom-document richtig?} bietet die HTML-Spezifikation in ihrer neusten Version (HTML5) im Grunde alles, was für die Entwicklung einer modernen Benutzerschnittstelle am Computer notwendig ist. 
