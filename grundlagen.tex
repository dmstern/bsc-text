...
\lstinputlisting[style=htmlcssjs, caption=\gls{jq}-Beispiel-Code zum Ausblenden aller Absätze \cite{jQuery_Examples_Tryit_Editor_v1.9_2014-04-11}., label=lst:jq]{code/jquery.html}

\lstinputlisting[style=htmlcssjs, caption=Die selbe Funktionalität wie in \autoref{lst:jq} mit reinem \gls{js}., label=lst:js]{code/without-jquery.html}
