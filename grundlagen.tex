...
Die öffentliche oder \gls{opensource}-\gls{app} muss in Form eines \gls{github}-Repositorys zugänglich gemacht werden. 
\begin{quote}
...
%TODO Zum Workflow: jeweilige PG-JS-Lib wird injected (Quelle: Docs)
%TODO Grafik Workflow evtl. nochmal in text erläutern und referenzieren.
...
\includegraphics[
	...
	\caption
		[\Gls{pg-build}-Pakete]
		{Übersicht über die verschiedenen Bezahlpakete von \gls{pg-build}: Ab 9,99\,\$ im Monat können Entwickler bis zu 25 private \glspl{app} anlegen, in der kostenlosen Variante nur eine.}
		\label{fig:phonegap-build_plans}
\end{figure}



%TODO GitHub oder EIGENES Git-Repo oder App hochladen.
...
%TODO Git-Repo
	%TODO Wie sieht es aus mit dieser halböffentlichkeit? Rechte an Adobe?
		%TODO -> Zumindest liegt der code bei Adobe (andererseits ist er ja auch sonst offen durch apk-Paket + JS...!)
%TODO Screenshots PG Build:
	%TODO -> Verschiedene Plattform-Formate zum Runterladen
%TODO Screenshot Test-App im Desktop-Browser und dann als mobile App.
...
\includegraphics[
	...
	natwidth=1,
	natheight=1,
	]{./images/phonegap-build.png}
	\caption[]{Screenshot des \gls{pg-build}-Portals}
...
%	natwidth=1,
%	natheight=1,
%	]{./images/phonegap-build-schaubild.png}
%	\caption[]{Schaubild des Workflows mit \gls{pg-build}}
%	\label{fig:phonegap-build-schaubild}
%\end{figure}
