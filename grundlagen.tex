...
\todo{woraus willst du hier eigentlich hinaus?}
...
\todo{das ist jetzt schon der nativ-web-vergleich. sollte der hier hin?}
...
Ein anderer wichtiger Punkt geht in die selbe Richtung\todo{oder ist er im prinzip der selbe?}: der Zugriff auf native Funktionalitäten des Geräts respektive des Betriebssystems werden nicht oder nur gering unterstützt.
