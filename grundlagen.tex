...
% Allgemein / Android
Als Programmiersprache für die Android-App-Entwicklung wird Java verwendet. Das heißt, als Voraussetzung für die Entwicklung von Android-Apps ist lediglich eine geeignete Entwicklungsumgebung wie \textsl{Eclipse}, \textsl{NetBeans\ IDE} oder \textsl{IntelliJ\ IDEA} sowie eine Installation des Java- und des Android-SDK nötig. 
...
% iOS: 
Auch der Software- und Computer-Hersteller Apple bietet mit \textsl{Xcode} eine firmeneigene IDE zur App-Entwicklung für sein mobiles Betriebssystem iOS an. Anders als Google geht der iPhone-Hersteller hier allerdings etwas restriktiver vor. So läuft die Entwicklungsumgebung Xcode, die man für die native iOS-Entwicklung benötigt, nur unter dem hauseigenen Betriebssystem Mac~OSX und das wiederum nur auf den firmeneigenen Mac-Rechnern. So sichert sich Apple auch durch jeden Entwickler einen neuen Kunden.\todo{darf man so was hier anmerken, oder lieber weg?}
