...
%TODO Quelle
Einige Möglichkeiten, eine Web-Anwendung offline-fähig zu machen, sind beispielsweise die aus der HTML5-Spezifikation hervorgehenden Technologien \textsl{localStorage} (oder \textsl{WebStorage})\cite{webstorage}, ein Mechanismus zum lokalen Speichern von größeren Datenmengen in Form von Schlüssel-Wert-Paaren sowie \textsl{WebSQL}\cite{webssql} bzw. \textsl{IndexedDB}\cite{indexedDB}, beides auf Web-Anwendungen otimierte Datenbanken-Spezifikationen des {\sc World Wide Web Consortiums}.
