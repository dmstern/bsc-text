...
\newglossaryentry{pg-build}{
	name = {PhoneGap\,Build}, %TODO Hier müsste eigentlich ne \mbox drum, steht dann aber ständig über.
	description = {Online-Portal von \gls{adobe}, das den Build-Prozess von \gls{phonegap}-\glspl{app} in die Cloud auslagert und damit die Anbindung von \glspl{hybrid-app} an plattformspezifische Komponenten verschiedener Mobilgeräte erleichtern soll},
	type = technologies
}

\newglossaryentry{github}{
	name = {GitHub},
	description = {Online-Portal, in dem \gls{git}-Repositories erstellt und verwaltet werden können mit dem Fokus auf \gls{opensource}-Software},
	type = technologies
}
...
\newglossaryentry{api}{
	name = {API},
	description = {Application Programming Interface (dt. \enduote{Programmierschnittstelle})},
